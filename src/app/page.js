...
export default function Home() {
        ...
        <Structure className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image src={profilePic} alt="Profile Image" className="w-full h-auto md:inline-block md:w-full" priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50px, 50px"/>
            </div>
  ...
  Explore my latest project, showcasing my expertise in web development and machine learning.</p>
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
          <Image src={LightBulb} alt="LightBulb" className="w-full h-auto hover:brightness-150"></Image>
        </div>
      </main>
    </>
  )
